...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Image ID="firstImage" runat="server" Height="250px" Width="250px" />
            <asp:Image ID="secondImage" runat="server" Height="250px" Width="250px" />
            <asp:Image ID="thirdImage" runat="server" Height="250px" Width="250px" />
            <br />
            <br />
