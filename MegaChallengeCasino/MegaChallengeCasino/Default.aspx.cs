...
namespace MegaChallengeCasino
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            firstImage.ImageUrl = "/Images/" + reels[0] + ".png";
            secondImage.ImageUrl = "/Images/" + reels[1] + ".png";
            thirdImage.ImageUrl = "/Images/" + reels[2] + ".png";
        }
        
        private string spinReel()
        {
            string[] images = new string[] { "Bar", "Bell", "Cherry", "Clover", "Diamond", "HorseShoe",
